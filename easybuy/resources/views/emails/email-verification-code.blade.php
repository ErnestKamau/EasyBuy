...
<head>
    ...
    <title>Email Verification Code - EasyBuy</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="message">Thank you for registering with EasyBuy! Please use the verification code below to verify your email address:</p>
            
            <div class="code-container">
                <div class="code">{{ $code }}</div>
            </div>
            
            <p class="message">Enter this code in the app to complete your registration. This code will expire in 10 minutes.</p>
