...
# EasyBuy Backend Services Startup Script
# This script starts all backend services (Laravel, Queue Worker, Echo Server)
# Note: Expo dev server is NOT started here - use 'eas build:dev' for that
...
# Print header
print_message "=========================================" "$BLUE"
print_message "  EasyBuy Backend Services Startup" "$BLUE"
print_message "=========================================" "$BLUE"
echo ""
print_message "Note: Expo dev server is NOT started here." "$YELLOW"
print_message "Use 'eas build:dev --platform android' to start Expo." "$YELLOW"
echo ""
...
# Print summary
print_message "=========================================" "$GREEN"
print_message "  All backend services are running!" "$GREEN"
print_message "=========================================" "$GREEN"
echo ""
print_message "Backend Services:" "$BLUE"
...
echo ""
print_message "Next step:" "$BLUE"
print_message "  Run 'cd client && eas build:dev --platform android' to start Expo" "$YELLOW"
echo ""
